...
const tracks: Track[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { id: 'cinematic-broadcast', label: 'E안', title: '시네마틱 스포츠 중계 레이스', description: '3,000m 레이스를 전체 무리·라이벌 접전·마지막 600m 스퍼트의 국면별 카메라로 중계하고, 컷인과 사진 판정으로 결승 감정 곡선을 강화합니다.', status: '체험 가능', question: '국면별 카메라 전환과 라이벌 포커스가 조작 없는 자동 레이스의 관람 몰입과 자전거 성장 동기를 높이는가?', controls: '성장 프리셋을 고른 뒤 자동 중계를 관람합니다. 중계 속도 x1/x2를 비교하고, 라이벌 포커스·마지막 600m 컷인·사진 판정·결과 보드가 과하지 않으면서 순위 경쟁을 선명하게 만드는지 확인합니다.', raceCinematicDemo: true, issueNumber: 231, documentId: 'race-cinematic-broadcast' },
    ],
  },
  {
    id: 'collection',
