...
function renderDemo(track: Track, variant: Variant) {
  ...
  const demoLabel = variant.raceDemo || variant.raceCinematicDemo ? '동일 시뮬레이션·시드 재현 · 참가비 500 · 390×810'
