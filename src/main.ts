...
type GameScreenDesignMode = 'warm-pixel-game-garage';
type Variant = {
  id: string;
  label: string;
  title: string;
...
const tracks: Track[] = [
  ...
  },
  {
    ...
    title: 'MVP 핵심 기능 통합',
    description: '머지 코어 C안의 실제 화면과 보드 위에 택배형 부품 수급과 부품별 장착·조립 과정을 연결해 MVP 핵심 기반을 검증합니다.',
    issueNumber: 113,
    variants: [
