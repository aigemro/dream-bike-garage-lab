...
화면 단위의 정보 구조와 사용성 실험을 에셋 표현 실험과 분리해 관리합니다.
...
| Profile & Support Screens | 프로필, 정산, 안내, 설정, 타이틀·로딩 | 정보 우선순위, 시선 흐름, 화면 전환 |

### Art & Audio

배경·캐릭터·UI·애니메이션·피드백·음악·효과음을 게임 규칙 및 화면 구조와 분리해 관리합니다.
...
1. 메인 화면에서 **MVP 핵심 플레이·메타 성장·화면 디자인·Art & Audio·플레이 기반·릴리스 통합** 영역을 구분합니다.
